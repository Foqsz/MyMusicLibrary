...
public class UpdateUserAccountInvalidTokenTest : MyLibraryMusicBookClassFixture
{
    private readonly string method = "user/update";

    private readonly Guid _userIdentifier;

    public UpdateUserAccountInvalidTokenTest(CustomWebApplicationFactory factory) : base(factory)
    {
